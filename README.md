...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pylablib-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13826&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pylablib-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pylablib` can be installed with:

```
conda install pylablib
```

It is possible to list all of the versions of `pylablib` available on your platform with:
